document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            const fieldName = input.name || input.getAttribute('data-field');
            
            clearError(input);
            
            if (!value) {
                const msg = errorMessages[fieldName]?.required || 'This field is required';
                showError(input, msg);
                return false;
            }
            
            if (input.type === 'email' || fieldName === 'email') {
            ...
            if ((fieldName === 'message' || input.tagName === 'TEXTAREA') && value.length < 10) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f226d9df-857f-4070-845f-1bdc3f1c38a6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f226d9df-857f-4070-845f-1bdc3f1c38a6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f226d9df-857f-4070-845f-1bdc3f1c38a6';
